...
export const mob2 = Mob2();

function Mob2() {
  const mob2 = new THREE.Group();
  mob2.position.x = position.currentTile * tileSize;
  mob2.position.y = position.currentRow * tileSize;

  const fish = new THREE.Mesh();
  const gltfLoader = new GLTFLoader();
    gltfLoader.load("./models/Fish_Strange.glb", (gltf) => {
